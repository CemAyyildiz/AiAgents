...
import { Bot, MessageSquare, Trash2, Plus, ArrowLeft, Calendar, Settings, RefreshCw } from 'lucide-react'
    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">AI Agent'larım</h1>
        ...
        <div className="mt-12 card">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Toplam Agent</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600 mb-1">
                {agents.filter(a => a.status === 'active').length}
              </div>
              <div className="text-sm text-gray-600">Aktif Agent</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-1">
                {new Set(agents.map(a => new Date(a.createdAt).toDateString())).size}
              </div>
              <div className="text-sm text-gray-600">Oluşturma Günü</div>
            </div>
          </div>
        </div>
      )}
